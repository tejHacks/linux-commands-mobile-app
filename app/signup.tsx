  ...
  return (
    <SafeAreaView className="flex-1 bg-blue-900">
      <View className="flex-1 items-center justify-center px-4">
        <Text className="text-white text-3xl mb-6 font-bold">Sign Up</Text>
        <TextInput
        ...
        <Link href="/login" className="text-blue-300 text-xl underline mb-4">
          Already have an account? Login
        </Link>
        <Link href="/forgot-password" className="text-blue-300 text-xl underline">
          Forgot Password?
        </Link>
