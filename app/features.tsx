  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-900">
      <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false}>
        <Text className="text-white text-3xl font-bold mb-4 mt-6">App Features</Text>
        ...
        <TouchableOpacity 
          ...
          onPress={sendEmail}
        >
          <Text className="text-white text-xl font-semibold text-center">Send via Email</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          className="bg-green-600 w-full max-w-md h-14 px-6 py-4 rounded-lg mb-6"
          onPress={sendWhatsApp}
        >
          <Text className="text-white text-xl font-semibold text-center">Send via WhatsApp (08086976247)</Text>
        </TouchableOpacity>
      </ScrollView>
